...
<html lang="{{ str_replace('_','-',app()->getLocale())}}">
    ...
    <!-- Source code ini berhasil menampilkan pesan error jikalau kotak input data tidak di isi atau jumlah karakter
    yang diisikan melebihi batas yang sudah ditentukan  -->
		...
		<nav class="navbar navbar-dark bg-dark">
				...
				<div class="offcanvas-content">
					...
					<div class="offcanvas-body">
						...
						<ul class="list-unstyled">
							...
							<li><a href="{{ route('tintas.index')}}" class="text-danger">Tampil Data</a></li>
			...
			<div class="container">
				...
				<h1 class="mt-5">Input Data Utama Tinta</h1>
					...
					<form action="{{ route('tintas.store')}}" method="POST" class="formulir-tinta form-control:focus form-control::placeholder">
