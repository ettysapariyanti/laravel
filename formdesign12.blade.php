...
<html lang="{{ str_replace('_','-',app()->getLocale())}}">
    ...
    <!--  ini adalah source code untuk form update data, yang nantinya hasil perubahan data di simpan di database mariadb . 
    
    perubahan dilakukan pada tanggal 4 November 2024  -->
