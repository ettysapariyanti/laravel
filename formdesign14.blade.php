...
<html lang="{{ str_replace('_','-',app()->getLocale())}}">
    ...
    <!-- Ini adalah form untuk menghapus data berdasarkan pada ID yang di ketikan . source code ini di upload 
    ...
    4 November 2024 -->
		...
		<title>Hapus Data Utama Tinta</title>
	...
	<body>
		...
		<nav class="navbar navbar-dark bg-dark">
			...
			<div class="container-fluid">
				...
				<button class="btn btn-danger" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasMenu">Tampil Daftar</button>
		...
		<!-- di bawah ini source code untuk form hapus datanya   -->
		
		
		<div class="container">
		
		
			<h1 class="mt-5">Hapus Data Utama Tinta</h1>
			
				<form action="{{ route('tintas.destroyData')}}" method="POST" class="formulir-tinta form-control:focus form-control::placeholder">
					...
					<div class="form-group mx-auto" style="width: 1250px; padding-top: 10px; padding-bottom: 5px;">
						...
						<input type="text" class="form-control @error('id') is-invalid @enderror input-form" name="id" id="id" value="{{ old('id')}}" placeholder ="Isikan ID Pengguna">
					...
					<div class="form-group" style="width: 1250px; padding-top: 10px; padding-bottom: 20px; padding-left: 20px; padding-right: 10px;">
						...
						<button type="submit" class="btn btn-custom btn-lg">Hapus</button>
