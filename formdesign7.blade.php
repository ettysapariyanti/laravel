...
<html lang="{{ str_replace('_','-',app()->getLocale())}}">
  ...
  <!-- ini udah bagus untuk tampilan, tinggal dibuatkan logic program atau SQL di belakangnya saja -->
	...
	<body>
		...
		<nav class="navbar navbar-dark bg-dark">
			...
			<!-- di bawah ini source code untuk form input datanya  -->
			
			
			<div class="container">
			
			
				<h1 class="mt-5">Input Data Utama Tinta</h1>
				
				
					<form action="" method="" class="formulir-tinta form-control:focus form-control::placeholder">
						...
						<div class="form-group mx-auto" style="width: 1250px; padding-top: 10px; padding-bottom: 5px;">
							...
							<input type="text" class="form-control input-form" name="id" id="id" value="{{ old("id")}}" placeholder="Isikan ID">
						...
						<div class="form-group mx-auto" style="width: 1250px; padding-top: 10px; padding-bottom: 5px;">
							...
							<input type="text" class="form-control input-form" name="merek" id="merek" value="{{ old('merek')}}" placeholder="Isikan Merek Tinta">
						...
						<div class="form-group mx-auto" style="width: 1250px; padding-top: 10px; padding-bottom: 5px;">
							...
							<input type="text" class="form-control input-form" name="tipe" id="tipe" value="{{ old('tipe')}}" placeholder="Isikan Tipe Tinta">
						...
						<div class="form-group mx-auto" style="width: 1250px; padding-top: 10px; padding-bottom: 5px;">
							...
							<input type="text" class="form-control input-form" name="warna" id="warna" value="{{ old('warna')}}" placeholder="Isikan Warna Tinta">
						...
						<div class="form-group mx-auto" style="width: 1250px; padding-top: 10px; padding-bottom: 5px;">
							...
							<input type="text" class="form-control input-form" name="kemasan" id="kemasan" value="{{ old('kemasan')}}" placeholder="Isikan Kemasan Tinta">
